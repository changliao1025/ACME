...
set PYTHONPATH to include 
    $CIME_DIR/scripts:$CIME_DIR/tools/load_balancing_tool/code
set PATH to include
    $CIME_DIR/tools/load_balancing_tool/code
...
script, located in cime/tools/load_balancing_tool/code/load_balancing_tool_submit.py. This creates output that can be
...
This MILP is solved using the PuLP python interface to the GLPK solver
...
************************************
The file $CIME_DIR/tools/load_balancing_tool/code/optimize_model.py
